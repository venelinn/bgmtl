...
const PAYPAL_DONATE_URL = "https://www.paypal.com/ca/fundraiser/charity/3456111";
  ...
  return (
    <aside className={styles["donate-widget"]}>
      ...
      <div className={styles["donate-widget__media"]}>
        ...
        <p className={styles["donate-widget__text"]}>{t("Donate.description")}</p>
      </div>
      ...
      <small className={styles["donate-widget__trust"]}>{t("Donate.trust")}</small>
    </aside>
  );
};
