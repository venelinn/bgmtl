...
export const Section = ({
  ...
  return (
    ...
    >
      {image && (
        <div className={cx(styles.section__image, "section-image", classNames?.image)} data-anim="section-img-wrap">
          <Image
            src={image.src}
            alt={image.alt || ""}
            fill
      ...
      <div className={cx(styles.section__inner, classNames?.inner)}>
        {heading?.heading && (
          <div className={styles.section__header} data-variant={headingVariant}>
            ...
            {description && (
              <div className={cx(styles.section__description, classNames?.description)}>
